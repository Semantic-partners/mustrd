...
class TestRunSpecs:
    def test_find_specs_in_path_and_run_them(self):
        ...
        assert results == [
            ...
            TestSkipped(URIRef(TEST_DATA.a_complete_delete_insert_with_a_table_result_scenario), MUST.RdfLib, message="Incompatible result type for an update statement found in delete_insert_spec_with_table_result.ttl." ),
            TestSkipped(URIRef(TEST_DATA.a_complete_delete_insert_with_inherited_given_and_empty_table_result_scenario), MUST.RdfLib, message="Attempted update on inherited state found in delete_insert_with_inherited_given_and_empty_table_result.ttl. Incompatible result type for an update statement found in delete_insert_with_inherited_given_and_empty_table_result.ttl." ),
            TestSkipped(URIRef(TEST_DATA.a_complete_delete_insert_with_inherited_given_scenario), MUST.RdfLib, message="Attempted update on inherited state found in delete_insert_with_inherited_given_spec.ttl." ),
            ...
            TestSkipped(URIRef(TEST_DATA.a_complete_select_scenario), MUST.RdfLib, message="Duplicate subject URI found in select_spec2.ttl."),
            ...
            TestSkipped(URIRef(TEST_DATA.a_complete_select_scenario_with_empty_graph_result), MUST.RdfLib, message="Incompatible result type for a select statement found in select_spec_with_empty_graph_result.ttl."),
            TestSkipped(URIRef(TEST_DATA.a_complete_select_scenario_with_statement_data_source_result), MUST.RdfLib, message="Incompatible result type for a select statement found in select_spec_with_statement_data_source_result.ttl."),
